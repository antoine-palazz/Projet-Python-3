...
fig1 = eda.create_energy_plots(
    DPE_data, "Conso_5_usages/m²_é_finale", "Emission_GES_5_usages_par_m²"
)
fig2 = eda.create_energy_plots(
    DPE_data, "Emission_GES_5_usages_par_m²", "Conso_5_usages/m²_é_finale"
)
